...
/*			BGUI
	Astrazione di un'entit� interfaccia ad un elemento grafico
*/
...
public:
	...
	/*Ritorna TRUE se la risorsa grafica � vuota (priva di componenti)*/
	...
	/*Accesso alle surface dei componenti. Nel caso di accesso per un indice inesistente, il vettore componenti verr� ridimensionato*/
	...
	Inoltre il 3 parametro � output e indica l'indice dell'array del componente della Bgui
